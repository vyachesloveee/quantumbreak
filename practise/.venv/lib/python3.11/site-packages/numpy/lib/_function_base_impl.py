...
def rot90(m, k=1, axes=(0, 1)):
    ...
    Examples
    --------
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/lib/_function_base_impl.py
=======
    >>> import numpy as np
>>>>>>> origin:practise/env/Lib/site-packages/numpy/lib/_function_base_impl.py
