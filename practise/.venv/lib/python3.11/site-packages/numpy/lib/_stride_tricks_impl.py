...
def sliding_window_view(x, window_shape, axis=None, *,
    ...
    positions.
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/lib/_stride_tricks_impl.py
    
=======

>>>>>>> origin:practise/env/Lib/site-packages/numpy/lib/_stride_tricks_impl.py
    .. versionadded:: 1.20.0
