...
class TestNanFunctions_CumSumProd(SharedNanFunctionsTestsMixin):
    ...
    def test_empty(self):
        for f, tgt_value in zip(self.nanfuncs, [0, 1]):
            ...
            res = f(mat, axis=1)
            assert_equal(res, tgt)
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/lib/tests/test_nanfunctions.py
            tgt = np.zeros((0))
=======
            tgt = np.zeros(0)
>>>>>>> origin:practise/env/Lib/site-packages/numpy/lib/tests/test_nanfunctions.py
            res = f(mat, axis=None)
            assert_equal(res, tgt)
