...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/lib/tests/test_arraysetops.py
=======
...
>>>>>>> origin:practise/env/Lib/site-packages/numpy/lib/tests/test_arraysetops.py
