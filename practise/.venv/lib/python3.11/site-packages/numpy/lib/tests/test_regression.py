...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/lib/tests/test_regression.py
        class C():
=======
        class C:
>>>>>>> origin:practise/env/Lib/site-packages/numpy/lib/tests/test_regression.py
