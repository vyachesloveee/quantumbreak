...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/lib/tests/test_function_base.py
...
=======
    ...
    IS_WASM, NOGIL_BUILD
>>>>>>> origin:practise/env/Lib/site-packages/numpy/lib/tests/test_function_base.py
    )
