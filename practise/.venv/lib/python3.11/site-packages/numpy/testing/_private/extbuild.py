...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/testing/_private/extbuild.py
...
=======
    ...
    #endif
>>>>>>> origin:practise/env/Lib/site-packages/numpy/testing/_private/extbuild.py
           """
    if not build_dir:
        build_dir = pathlib.Path('.')
    if more_init:
