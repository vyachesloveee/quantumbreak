...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/testing/tests/test_utils.py
...
=======
    with (pytest.warns(DeprecationWarning, match=dep_message),
          pytest.raises(TypeError, match=type_message)):
>>>>>>> origin:practise/env/Lib/site-packages/numpy/testing/tests/test_utils.py
        assert_func(1, x=1)
        assert_func(1, 2, y=2)
