...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/_core/include/numpy/npy_common.h
#ifdef HAVE___THREAD
...
#else
    #define NPY_TLS
>>>>>>> origin:practise/env/Lib/site-packages/numpy/_core/include/numpy/npy_common.h
#endif
