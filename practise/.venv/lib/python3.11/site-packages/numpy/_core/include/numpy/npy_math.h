...
{
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/_core/include/numpy/npy_math.h
    return ((double *) &z)[0];
=======
    ...
    return creal(z);
#endif
>>>>>>> origin:practise/env/Lib/site-packages/numpy/_core/include/numpy/npy_math.h
}
