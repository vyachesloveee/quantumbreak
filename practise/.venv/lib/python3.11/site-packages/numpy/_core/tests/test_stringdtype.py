...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/_core/tests/test_stringdtype.py
from numpy.testing import assert_array_equal, IS_WASM
=======
from numpy.testing import assert_array_equal, IS_WASM, IS_PYPY
>>>>>>> origin:practise/env/Lib/site-packages/numpy/_core/tests/test_stringdtype.py
