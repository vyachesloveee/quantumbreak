...
import numpy as np
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/_core/tests/test_mem_policy.py
...
>>>>>>> origin:practise/env/Lib/site-packages/numpy/_core/tests/test_mem_policy.py
@pytest.fixture
