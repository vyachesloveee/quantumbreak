...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/_core/tests/test_regression.py
        assert_((xp.__array_interface__['data'][0] !=
                xpd.__array_interface__['data'][0]))
=======
        assert_(xp.__array_interface__['data'][0] !=
                xpd.__array_interface__['data'][0])
>>>>>>> origin:practise/env/Lib/site-packages/numpy/_core/tests/test_regression.py
