...
class TestFromrecords:
    ...
    def test_recarray_from_obj(self):
        ...
        for i in range(len(a)):
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/_core/tests/test_records.py
...
=======
            ...
            assert_(mine.data1[i] == 0.0)
            assert_(mine.data2[i] == 0.0)
>>>>>>> origin:practise/env/Lib/site-packages/numpy/_core/tests/test_records.py
