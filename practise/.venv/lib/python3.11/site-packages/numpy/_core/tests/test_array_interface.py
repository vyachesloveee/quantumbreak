...
import pytest
import numpy as np
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/_core/tests/test_array_interface.py
from numpy.testing import extbuild, IS_WASM
=======
from numpy.testing import extbuild, IS_WASM, IS_EDITABLE
>>>>>>> origin:practise/env/Lib/site-packages/numpy/_core/tests/test_array_interface.py
