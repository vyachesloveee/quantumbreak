...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/_core/tests/test_dlpack.py
class TestDLPack:
...
>>>>>>> origin:practise/env/Lib/site-packages/numpy/_core/tests/test_dlpack.py
