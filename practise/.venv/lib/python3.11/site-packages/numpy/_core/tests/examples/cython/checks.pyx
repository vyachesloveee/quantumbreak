...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/_core/tests/examples/cython/checks.pyx
=======
def get_ravel_axis():
    return cnp.NPY_RAVEL_AXIS


>>>>>>> origin:practise/env/Lib/site-packages/numpy/_core/tests/examples/cython/checks.pyx
