...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/_core/tests/test_hashtable.py
...
=======
    ...
    keys_vals[0] = new_key
>>>>>>> origin:practise/env/Lib/site-packages/numpy/_core/tests/test_hashtable.py
