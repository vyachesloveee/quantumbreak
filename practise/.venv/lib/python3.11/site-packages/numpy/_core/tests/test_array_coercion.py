...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/_core/tests/test_array_coercion.py
    class _SequenceLike():
=======
    class _SequenceLike:
>>>>>>> origin:practise/env/Lib/site-packages/numpy/_core/tests/test_array_coercion.py
