...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/_core/tests/test_scalarinherit.py
=======
    def test_int_repr(self):
        ...
        s = repr(my_int16(3))
        assert s == "my_int16(3)"
>>>>>>> origin:practise/env/Lib/site-packages/numpy/_core/tests/test_scalarinherit.py
