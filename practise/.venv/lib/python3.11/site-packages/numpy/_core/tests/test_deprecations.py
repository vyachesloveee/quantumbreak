...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/_core/tests/test_deprecations.py
    KnownFailureException, break_cycles,
=======
    KnownFailureException, break_cycles, temppath
>>>>>>> origin:practise/env/Lib/site-packages/numpy/_core/tests/test_deprecations.py
    )
