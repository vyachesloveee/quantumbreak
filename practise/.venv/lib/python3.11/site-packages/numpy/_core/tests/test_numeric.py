...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/_core/tests/test_numeric.py
from numpy._core.arrayprint import set_string_function
=======
>>>>>>> origin:practise/env/Lib/site-packages/numpy/_core/tests/test_numeric.py
