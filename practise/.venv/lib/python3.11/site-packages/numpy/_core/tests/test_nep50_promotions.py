...
import operator
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/_core/tests/test_nep50_promotions.py
=======
import threading
import warnings
>>>>>>> origin:practise/env/Lib/site-packages/numpy/_core/tests/test_nep50_promotions.py
