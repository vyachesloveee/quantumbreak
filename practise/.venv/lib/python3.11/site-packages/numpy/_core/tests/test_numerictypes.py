...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/_core/tests/test_numerictypes.py
...
>>>>>>> origin:practise/env/Lib/site-packages/numpy/_core/tests/test_numerictypes.py
