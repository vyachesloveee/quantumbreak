...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/_core/tests/test_limited_api.py
from numpy.testing import IS_WASM, IS_PYPY
=======
from numpy.testing import IS_WASM, IS_PYPY, NOGIL_BUILD, IS_EDITABLE
>>>>>>> origin:practise/env/Lib/site-packages/numpy/_core/tests/test_limited_api.py
