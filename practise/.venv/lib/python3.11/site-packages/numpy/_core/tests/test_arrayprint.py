...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/_core/tests/test_arrayprint.py
    assert_raises_regex,
    )
=======
...
>>>>>>> origin:practise/env/Lib/site-packages/numpy/_core/tests/test_arrayprint.py
