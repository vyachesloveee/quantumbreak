...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/_core/tests/test_cpu_features.py
        for f in map_names:
...
>>>>>>> origin:practise/env/Lib/site-packages/numpy/_core/tests/test_cpu_features.py
