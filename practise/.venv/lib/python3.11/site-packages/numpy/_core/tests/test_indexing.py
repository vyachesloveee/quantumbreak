...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/_core/tests/test_indexing.py
                arr = arr.reshape((arr.shape[:ax] + (1,) + arr.shape[ax:]))
=======
                arr = arr.reshape(arr.shape[:ax] + (1,) + arr.shape[ax:])
>>>>>>> origin:practise/env/Lib/site-packages/numpy/_core/tests/test_indexing.py
                continue
            if isinstance(indx, np.ndarray) and indx.dtype == bool:
