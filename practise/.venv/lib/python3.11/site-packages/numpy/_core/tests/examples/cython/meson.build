...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/_core/tests/examples/cython/meson.build
=======
cython_args = []
...
>>>>>>> origin:practise/env/Lib/site-packages/numpy/_core/tests/examples/cython/meson.build
