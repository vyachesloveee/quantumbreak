...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/_core/tests/test_overrides.py
        class MyArray():
=======
        class MyArray:
>>>>>>> origin:practise/env/Lib/site-packages/numpy/_core/tests/test_overrides.py
