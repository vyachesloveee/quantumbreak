...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/_core/tests/test_scalarmath.py
=======
from numpy._core._rational_tests import rational
>>>>>>> origin:practise/env/Lib/site-packages/numpy/_core/tests/test_scalarmath.py
