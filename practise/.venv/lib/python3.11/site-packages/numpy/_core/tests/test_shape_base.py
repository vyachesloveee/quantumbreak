...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/_core/tests/test_shape_base.py
            hstack((np.arange(3) for _ in range(2)))
=======
            hstack(np.arange(3) for _ in range(2))
>>>>>>> origin:practise/env/Lib/site-packages/numpy/_core/tests/test_shape_base.py
        with pytest.raises(TypeError, match="arrays to stack must be"):
