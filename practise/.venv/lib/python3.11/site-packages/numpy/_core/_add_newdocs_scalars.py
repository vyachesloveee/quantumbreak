...
add_newdoc_for_scalar_type('datetime64', [],
    ...
    >>> np.datetime64(10, 'Y')
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/_core/_add_newdocs_scalars.py
...
>>>>>>> origin:practise/env/Lib/site-packages/numpy/_core/_add_newdocs_scalars.py
