...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/f2py/tests/test_array_from_pyobj.py
        for name in names:
...
>>>>>>> origin:practise/env/Lib/site-packages/numpy/f2py/tests/test_array_from_pyobj.py
