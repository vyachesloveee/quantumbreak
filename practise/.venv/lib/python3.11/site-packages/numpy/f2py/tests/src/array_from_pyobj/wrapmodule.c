...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/f2py/tests/src/array_from_pyobj/wrapmodule.c
                       PyDataType_ALIGNMENT(arr),
=======
                       PyDataType_ALIGNMENT(PyArray_DESCR(arr)),
>>>>>>> origin:practise/env/Lib/site-packages/numpy/f2py/tests/src/array_from_pyobj/wrapmodule.c
                       PyArray_FLAGS(arr),
                       PyArray_ITEMSIZE(arr));
}
