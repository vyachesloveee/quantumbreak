...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/f2py/tests/test_crackfortran.py
class TestModuleProcedure():
=======
class TestModuleProcedure:
>>>>>>> origin:practise/env/Lib/site-packages/numpy/f2py/tests/test_crackfortran.py
