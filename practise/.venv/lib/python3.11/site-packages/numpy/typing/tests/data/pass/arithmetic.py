...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/typing/tests/data/pass/arithmetic.py
from typing import Any, Optional
=======
from typing import Any
>>>>>>> origin:practise/env/Lib/site-packages/numpy/typing/tests/data/pass/arithmetic.py
import numpy as np
import pytest
