...
AR_LIKE_U: list[str]
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/typing/tests/data/reveal/index_tricks.pyi
...
>>>>>>> origin:practise/env/Lib/site-packages/numpy/typing/tests/data/reveal/index_tricks.pyi
