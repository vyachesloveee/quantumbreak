...
f8: np.float64
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/typing/tests/data/reveal/ndarray_misc.pyi
B: SubClass
...
>>>>>>> origin:practise/env/Lib/site-packages/numpy/typing/tests/data/reveal/ndarray_misc.pyi
