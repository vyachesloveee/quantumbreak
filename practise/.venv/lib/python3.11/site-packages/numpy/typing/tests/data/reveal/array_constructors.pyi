...
C: list[int]
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/typing/tests/data/reveal/array_constructors.pyi
=======
D: SubClass[np.float64 | np.int64]
>>>>>>> origin:practise/env/Lib/site-packages/numpy/typing/tests/data/reveal/array_constructors.pyi
