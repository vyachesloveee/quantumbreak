...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/random/tests/test_smoke.py
        assert_((type(self.rg) == type(unpick)))
=======
        assert_(type(self.rg) == type(unpick))
>>>>>>> origin:practise/env/Lib/site-packages/numpy/random/tests/test_smoke.py
