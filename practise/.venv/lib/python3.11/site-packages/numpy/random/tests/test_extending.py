...
import numpy as np
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/random/tests/test_extending.py
from numpy.testing import IS_WASM
=======
from numpy.testing import IS_WASM, IS_EDITABLE
>>>>>>> origin:practise/env/Lib/site-packages/numpy/random/tests/test_extending.py
