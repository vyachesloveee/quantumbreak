...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/random/_examples/cython/meson.build
=======
base_cython_args = []
...
>>>>>>> origin:practise/env/Lib/site-packages/numpy/random/_examples/cython/meson.build
