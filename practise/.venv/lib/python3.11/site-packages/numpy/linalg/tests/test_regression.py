...
class TestRegression:
    ...
    def test_matrix_rank_rtol_argument(self, rtol):
        ...
        assert res.shape == (4,)
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/linalg/tests/test_regression.py
=======
...
>>>>>>> origin:practise/env/Lib/site-packages/numpy/linalg/tests/test_regression.py
