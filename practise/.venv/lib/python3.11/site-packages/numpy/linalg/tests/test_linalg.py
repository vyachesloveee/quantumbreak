...
import sys
import itertools
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/linalg/tests/test_linalg.py
=======
import threading
>>>>>>> origin:practise/env/Lib/site-packages/numpy/linalg/tests/test_linalg.py
import traceback
import textwrap
import subprocess
import pytest
