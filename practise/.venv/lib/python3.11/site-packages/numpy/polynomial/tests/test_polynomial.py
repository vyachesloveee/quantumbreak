...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/numpy/polynomial/tests/test_polynomial.py
=======
import numpy.polynomial.polyutils as pu
>>>>>>> origin:practise/env/Lib/site-packages/numpy/polynomial/tests/test_polynomial.py
import pickle
