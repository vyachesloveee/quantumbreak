...
class AlreadyInstalledCandidate(Candidate):
    ...
    @property
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/pip/_internal/resolution/resolvelib/candidates.py
...
=======
    def version(self) -> Version:
        if self._version is None:
            self._version = self.dist.version
        return self._version
>>>>>>> origin:practise/env/Lib/site-packages/pip/_internal/resolution/resolvelib/candidates.py
