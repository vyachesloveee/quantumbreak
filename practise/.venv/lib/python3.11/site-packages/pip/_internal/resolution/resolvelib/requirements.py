...
class SpecifierRequirement(Requirement):
    def __init__(self, ireq: InstallRequirement) -> None:
        ...
        self._ireq = ireq
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/pip/_internal/resolution/resolvelib/requirements.py
        self._extras = frozenset(ireq.extras)
=======
        self._equal_cache: Optional[str] = None
        self._hash: Optional[int] = None
        self._extras = frozenset(canonicalize_name(e) for e in self._ireq.extras)
>>>>>>> origin:practise/env/Lib/site-packages/pip/_internal/resolution/resolvelib/requirements.py
