...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/pip/_internal/metadata/pkg_resources.py
...
>>>>>>> origin:practise/env/Lib/site-packages/pip/_internal/metadata/pkg_resources.py
