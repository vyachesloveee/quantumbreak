...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/pip/_internal/commands/install.py
...
>>>>>>> origin:practise/env/Lib/site-packages/pip/_internal/commands/install.py
                    )
                )
