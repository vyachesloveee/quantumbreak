...
def uninstallation_paths(dist: BaseDistribution) -> Generator[str, None, None]:
    ...
    if entries is None:
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/pip/_internal/req/req_uninstall.py
...
>>>>>>> origin:practise/env/Lib/site-packages/pip/_internal/req/req_uninstall.py
