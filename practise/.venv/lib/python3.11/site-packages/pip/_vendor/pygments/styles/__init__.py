...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/pip/_vendor/pygments/styles/__init__.py
...
>>>>>>> origin:practise/env/Lib/site-packages/pip/_vendor/pygments/styles/__init__.py
        builtin = "yes"
    else:
