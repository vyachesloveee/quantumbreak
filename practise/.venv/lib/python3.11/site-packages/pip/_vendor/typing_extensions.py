...
__all__ = [
    ...
    'clear_overloads',
    'dataclass_transform',
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/pip/_vendor/typing_extensions.py
=======
    'deprecated',
    'Doc',
>>>>>>> origin:practise/env/Lib/site-packages/pip/_vendor/typing_extensions.py
    'get_overloads',
    'final',
    'get_args',
    'get_origin',
