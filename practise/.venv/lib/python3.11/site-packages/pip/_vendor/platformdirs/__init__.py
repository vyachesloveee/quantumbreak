...
<<<<<<< HEAD:practise/.venv/lib/python3.11/site-packages/pip/_vendor/platformdirs/__init__.py
=======
if TYPE_CHECKING:
    from pathlib import Path
    from typing import Literal

>>>>>>> origin:practise/env/Lib/site-packages/pip/_vendor/platformdirs/__init__.py
